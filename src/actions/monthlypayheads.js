...
export const adminGetAllMonthlyPayheads = () => async (dispatch) => {
  ...
  try {
    ...
    const { data } = await axios.get(`${urlConfig.url.PROXYURL}api/monthlypayhead`, config);
...
export const adminCreateMonthlyPayhead = (formData) => async (dispatch) => {
  ...
  try {
    ...
    await axios.post(`${urlConfig.url.PROXYURL}api/monthlypayhead`, body, config);
...
export const adminUpdateMonthlyPayheadById =
  (id, formData) => async (dispatch) => {
    ...
    try {
      ...
      const body = JSON.stringify(formData);
      await axios.patch(`${urlConfig.url.PROXYURL}api/monthlypayhead/${id}`, body, config);
...
export const adminDeleteMonthlyPayheadById = (id) => async (dispatch) => {
  ...
  try {
    ...
    await axios.delete(`${urlConfig.url.PROXYURL}api/monthlypayhead/${id}`, config);
