...
//       findPos = staffLevels.find((el) => String(el?._id) === String(id));
//       if (findPos) {
//         setFormData({
//           name: findPos?.name,
...
//     e.preventDefault();
//     if (formData?._id) {
//       dispatch(adminUpdateStaffLevel({ name, salary }, formData?._id));
//     } else {
...
//   return (
//     <>
//       {loadingStafflevel && <LoadingSpinner />}
//       {loadingStafflevel && <LoadingSpinner />}
//       {staffLevelId && (
//         <Comfirm
//           isOpen4={isOpen4}
...
//                                 <div
//                                   className="icons"
//                                   onClick={(e) => onSelect(staffLevel?._id)}
//                                 >
//                                   {" "}
//                                   <FontAwesomeIcon
//                                     icon={["fas", "edit"]}
...
//                                 <div
//                                   className="icons"
//                                   onClick={(e) => popup4(staffLevel?._id)}
//                                 >
//                                   {" "}
//                                   <FontAwesomeIcon
//                                     icon={["fas", "trash-alt"]}
